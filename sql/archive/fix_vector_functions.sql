-- Fix Vector Functions for Supabase (bigint vs int issue)

-- Drop and recreate function for semantic search with correct types
...
-- Drop and recreate function to find similar content with correct types
...
-- Update helper function with correct types
...
-- Test the functions
SELECT 'Vector functions updated successfully - now using bigint for id columns' as status;